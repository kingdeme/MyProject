...
//    快捷导航 左半部分 位置
    ...
    function bindDom(arr){
        for(var i=0, len=arr.length; i<len; i++){
            //创建一个li标签
            $(".slider-list").append('<li class="slider-item" style="opacity:0;z-index: 0;position: absolute;"><a class="slider-item-lk" href="javascript:void(0)"><img class="slider-item-img" src="'+path+arr[i]+'"></a>');
            //创建一个i标签
    ...
    $.ajax({
        ...
        success:function (seckill) {
            ...
            for(var i=0; i<obj.seckill.length; i++){
                ...
                var picCont = $('<a href="javascript:void (0)" class="sk-item-pic-lk"><img src="'+path+obj.seckill[i].imgSrc+'" class="sk-item-img" alt=""><p class="sk-item-name">'+obj.seckill[i].name+'</p></a><span class="sk-item-shadow"></span>');
    ...
    $.ajax({
        ...
        success:function (coupon) {
            ...
            for(var i=0; i<obj.coupon.length; i++){
                $(".coupon-list").append(' <li class="coupon-item"><a href="javascript:void (0)" class="coupon-item-lk"><div class="coupon-info"><p class="coupon-price"><i>￥</i>'+obj.coupon[i].price+'</p><p class="coupon-desc"><i class="mod-ver"></i><span class="coupon-desc-txt">'+obj.coupon[i].desc+'</span></p><p class="coupon-limit"><i class="mod-ver"></i><span class="coupon-limit-txt">'+obj.coupon[i].limit+'</span></p><p class="coupon-more">'+obj.coupon[i].more+'</p></div><img src="'+path+obj.coupon[i].imgSrc+'" class="coupon-img" alt=""></a><span class="coupon-item-shadow"></span></li>')
            }
        }
    });
    ...
    $.ajax({
        ...
        success:function (find) {
            ...
            for(var i=0; i<obj.find.length; i++){
                var num = i+1;
                $(".find-list").append(' <li class="find-item find-item'+num+'"><a href="javascript:void (0)" class="find-item-lk"><p class="find-item-name">'+obj.find[i].names+'</p><img src="'+path+obj.find[i].imgSrc+'" alt="" class="find-item-img"></a></li>')
            }
        }
    })
    ...
    function jiazai(obj){
        ...
        for(var i=0; i<obj.top.length; i++){
            var a = $('<a href="javascript:void (0)" class="top-bottom-head-item">'+obj.top[i].topName+'</a>');
            ...
            for(var j=0; j<obj.top[i].topcontent.length; j++){
                var num = j+1;
                var li = $('<li class="top-item top-item-'+num+'"><a href="javascript:void (0)" class="top-lk"><div class="top-rank top-rank-'+num+'">'+obj.top[i].topcontent[j].topId+'</div><div class="top-pic"><img src="'+path+obj.top[i].topcontent[j].imgSrc+'" class="top-img"></div><p class="top-name">'+obj.top[i].topcontent[j].name+'</p></a></li>');
                ul.append(li);
            }
    ...
    function  cloth(obj){
        ...
        for(var i=0; i<obj.clothBeauty.length; i++){
            ...
            for(var k=0; k<obj.clothBeauty[i].pags.length; k++){
                tags.append(' <a href="javascript:void (0)" class="pt-tags-item">'+obj.clothBeauty[i].pags[k]+'</a>')
            }// tags循环
            ...
            var pre = $('<a href="javascript:void (0)" class="pt-logo-btn pt-logo-pre iconfont">&#xe640;</a>');
            var next = $('<a href="javascript:void (0)" class="pt-logo-btn pt-logo-next iconfont">&#xe63f;</a>');
            for(var j=0; j<obj.clothBeauty[i].cont.length; j++){
                var b=j+1;
                var divbtm = $('<div class="pt-bottom pt-bottom-'+b+'"></div>');
                divBottom.append(divbtm);
                var coverA = $(' <a href="javascript:void (0)" class="pt-cover-lk"> <img src="'+path+obj.clothBeauty[i].cont[j].cover+'" class="pt-cover-img" alt=""></a>');
                for(var l=0; l<obj.clothBeauty[i].cont[j].bi.length; l++){
                    var biA = $(' <a href="javascript:void (0)" class="pt-bi-item"><p class="pt-bi-tit">'+obj.clothBeauty[i].cont[j].bi[l].tit+'</p><p class="pt-bi-promo">'+obj.clothBeauty[i].cont[j].bi[l].promo+'</p><img src="'+path+obj.clothBeauty[i].cont[j].bi[l].imgSrc+'" class="pt-bi-img" alt=""></a>');
                    bi.append(biA);
                }
                for(var m=0; m<obj.clothBeauty[i].cont[j].more.length; m++){
                    var moreA = $(' <a href="javascript:void (0)" class="pt-more-item"><img src="'+path+obj.clothBeauty[i].cont[j].more[m]+'" class="pt-more-img" alt=""></a>');
                    more.append(moreA);
                }
            ...
            for(var f=0; f<obj.clothBeauty[i].ft.length; f++){
                var liItem = $('<li class="pt-logo-item"><a href="javascript:void (0)" class="pt-logo-lk"><img src="'+pathLogo+obj.clothBeauty[i].ft[f]+'" class="pt-logo-img" alt=""></a></li>');
    ...
    function  computer(arr){
        ...
        for(var i=0; i<arr.clothBeauty.length; i++){
            ...
            for(var k=0; k<arr.clothBeauty[i].pags.length; k++){
                tags.append(' <a href="javascript:void (0)" class="pt-tags-item">'+arr.clothBeauty[i].pags[k]+'</a>')
            }// tags循环
            var divBottom = $('<div class="pt-bottom-wrap"></div>');//底部外套
            var divFt = $('<div class="pt-ft"></div>');
            var ftLogo = $('<div class="pt-logo"></div>');
            ...
            for(var j=0; j<arr.clothBeauty[i].cont.length; j++){
                ...
                for(var c=0; c<arr.clothBeauty[i].cont[j].cover.length; c++){
                    var cover = $('<div class="pt-cover"></div>');
                    var coverA = $(' <a href="javascript:void (0)" class="pt-cover-lk"> <img src="'+path+arr.clothBeauty[i].cont[j].cover[c]+'" class="pt-cover-img" alt=""></a>');
                    cover.append(coverA);
                ...
                for(var l=0; l<arr.clothBeauty[i].cont[j].bi.length; l++){
                    var biA = $(' <a href="javascript:void (0)" class="pt-bi-item"><p class="pt-bi-tit">'+arr.clothBeauty[i].cont[j].bi[l].tit+'</p><p class="pt-bi-promo">'+arr.clothBeauty[i].cont[j].bi[l].promo+'</p><img src="'+path+arr.clothBeauty[i].cont[j].bi[l].imgSrc+'" class="pt-bi-img" alt=""></a>');
                    bi.append(biA);
                }
                for(var m=0; m<arr.clothBeauty[i].cont[j].more.length; m++){
                    var moreA = $(' <a href="javascript:void (0)" class="pt-more-item"><img src="'+path+arr.clothBeauty[i].cont[j].more[m]+'" class="pt-more-img" alt=""></a>');
                    more.append(moreA);
                }
            }
            ...
            for(var f=0; f<arr.clothBeauty[i].ft.length; f++){
                var liItem = $('<li class="pt-logo-item"><a href="javascript:void (0)" class="pt-logo-lk"><img src="'+pathLogo+arr.clothBeauty[i].ft[f]+'" class="pt-logo-img" alt=""></a></li>');
                ulList.append(liItem);
            }
            logoBtn.append(pre).append(next);
            logoList.append(ulList);
        ...
        for(var i=0; i<obj.clothBeauty.length; i++){
            ...
            for(var j=0; j<obj.clothBeauty[i].cont.length; j++){
                ...
                for(var c=0; c<obj.clothBeauty[i].cont[j].cover.length; c++){
                    var cover = $('<div class="pt-cover"></div>');
                    var coverA = $(' <a href="javascript:void (0)" class="pt-cover-lk"> <img src="'+path+obj.clothBeauty[i].cont[j].cover[c]+'" class="pt-cover-img" alt=""></a>');
                    cover.append(coverA);
                    bottomInner.append(cover);
                }
                for(var l=0; l<obj.clothBeauty[i].cont[j].bi.length; l++){
    ...
    function  xuni(arr){
        ...
        for(var i=0; i<arr.clothBeauty.length; i++){
            ...
            for(var j=0; j<arr.clothBeauty[i].cont.length; j++){
                ...
                var coverA = $(' <a href="javascript:void (0)" class="pt-cover-lk"> <img src="'+path+arr.clothBeauty[i].cont[j].cover+'" class="pt-cover-img" alt=""></a>');
                cover.append(coverA);
                bi.append(spanw).append(spanh);
                divBottom.append(divbtm);
                bottomInner.append(cover).append(bi).append(more);
    ...
    $.ajax({
        ...
        success:function (gts) {
            ...
            for(var i=0; i<obj.gts.length; i++){
                $(".gts-list").append('<li class="gts-item"><a href="javascript:void (0)" class="gts-lk"><div class="gts-bg" style="background-color:'+obj.gts[i].bgcolor+'"><div class="gts-info"><h4 class="gts-info-tit">'+obj.gts[i].tit+'</h4><p class="gts-info-desc">'+obj.gts[i].desc+'</p></div></div><img src="'+path+obj.gts[i].imgSrc+'" class="gts-img" alt=""></a></li>')
            }
        }
    })
    ...
    $.ajax({
        ...
        success:function (more) {
            ...
            for(var i=0; i<obj.more.length; i++){
                var num = i+1
                $(".more-list").append('<li class="more-item more-item-'+num+'"><a href="javascript:void (0)" class="more-item-lk"><img src="'+path+obj.more[i].imgSrc+'" class="more-img" alt=""><div class="more-info"><p class="more-info-name">'+obj.more[i].name+'</p><p class="more-info-price"><i>￥</i><span class="more-info-price-txt">'+obj.more[i].price+'</span></p></div></a></li>')
            }
        },
        error:function (msg) {
            alert(msg);
